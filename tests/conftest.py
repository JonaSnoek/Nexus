...
Environment variables used by the application MUST be set before any
application module is imported, so that ``app.core.config.settings`` picks up
the isolated test database. Application imports therefore happen at module
level *after* the environment block below.
"""
...
# ---------------------------------------------------------------------------
# Make the backend package importable (tests/ lives next to backend/).
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
TEST_DB_PATH = Path(tempfile.gettempdir()) / "nexus_test_root.db"
